...
/**
 * SchoolDistrictCodesFixture
 *
 */
class SchoolDistrictCodesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'year' => ['type' => 'string', 'length' => 4, 'null' => false, 'default' => null, 'collate' => 'utf8mb4_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        '_constraints' => [
